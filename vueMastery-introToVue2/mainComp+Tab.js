// iletisim dededen eventBus la toruna aktariliyor.
...
<!--    <div> <a :href="surgedu"><button>Surgedu</button></a></div> -->
    ...
    <div class="product-info">
        ...
        <product-details :shipping="shipping" :details="details"></product-details>
    ...
    methods: {
        ...
        // addReview (productReview) {    eventBus ta bu metoda gerek kalmiyor icini MOUNTED a aliyoruz
    ...
    methods: {
        onSubmit () {
            if (this.name && this.review && this.rating) {
                ...
                // this.$emit('review-submitted',productReview)  bunu asagidaki sekilde eventBusa aktariyoruz
...
Vue.component('product-details',{
    ...
    template: `
        <div>            
            <span class="sdtab" :class=" {activeTab:sdSelectedTab ===sdTab}"
                    v-for="(sdTab,index) in sdTabs"
                    :key="index"
                    @click="sdSelectedTab =sdTab">
                    {{ sdTab }} </span>
            <p v-show="sdSelectedTab === 'Shipping'" >Shipping: {{shipping}} </p>

            <ul v-show="sdSelectedTab === 'Details'" >
    ...
    data() {
        return {
            sdTabs:['Shipping','Details'],
            sdSelectedTab:'Details',            
        }
    },
})
